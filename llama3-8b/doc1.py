...
# Load the model manually onto the GPU and quantize to 4-bits
model = AutoModelForCausalLM.from_pretrained("SweatyCrayfish/llama-3-8b-quantized") 

# Manually move the model to GPU
model.to("cuda")
...
chunks = split_text(jud_text, chunk_size=250)  # Split the text into chunks of 400 tokens
